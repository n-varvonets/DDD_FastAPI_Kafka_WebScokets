...
1. я так и не понял
- Агрегаты - они собирают сущности в единное, как массив? дай пример.
- почему "Доменные сервисы" входят в "предметная область (Domain)" ? ведь с утверждения 1.1. сервисы - это Business Logic
- то же самое и про события, где они есть в  Application Logic или  Business Logic? это ж тоже не   "предметная область (Domain)" с утверждения 1.1.?
- что такое Use Cases и куда они входят в системе?  
[Ответ в по ссылке](./imgs_expl/5_1_DDD_Layers_Explained)
2.
...
- а ивента накапливать в use кейсе... что такое юз кейс?  
[Ответ в по ссылке](./imgs_expl/4_ddd_entities_usecases)
